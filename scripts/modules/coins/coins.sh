...
check_json_expr "category list returns CoinGecko-compatible category rows" "/coins/categories/list" 'type == "array" and length > 0 and ([.[0] | has("category_id") and has("name")] | all(.))' "category list returns a bare identifier/name row array"
