export const DEFAULT_CCXT_EXCHANGES = ['binance', 'bybit', 'coinbase', 'kraken', 'okx', 'gate', 'mexc', 'bitget'] as const;
...
export const DEFAULT_OHLCV_TARGET_HISTORY_DAYS = 365;
export const DEFAULT_OHLCV_RETENTION_DAYS = 365;
