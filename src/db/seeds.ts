...
const seededDerivativesExchanges = [
  ...
  { id: 'okx', name: 'OKX', openInterestBtc: 118000, tradeVolume24hBtc: 585000, numberOfPerpetualPairs: 330, numberOfFuturesPairs: 18, yearEstablished: 2017, country: 'Seychelles', description: 'OKX is a global cryptocurrency exchange with spot and derivatives markets.', url: 'https://www.okx.com', imageUrl: 'https://assets.coingecko.com/markets/images/96/small/WeChat_Image_20220117220452.png', centralised: true, updatedAt: new Date(seedTimestamp) },
  { id: 'bitget', name: 'Bitget', openInterestBtc: 96000, tradeVolume24hBtc: 410000, numberOfPerpetualPairs: 280, numberOfFuturesPairs: 12, yearEstablished: 2018, country: 'Seychelles', description: 'Bitget is a cryptocurrency exchange offering spot and derivatives markets.', url: 'https://www.bitget.com', imageUrl: 'https://assets.coingecko.com/markets/images/540/small/bitget.png', centralised: true, updatedAt: new Date(seedTimestamp) },
];
