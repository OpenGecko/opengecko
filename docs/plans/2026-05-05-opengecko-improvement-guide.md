...
| --- | --- | --- | --- | --- |
| 1 | Expand live onchain analytics replay coverage | Add replay fixtures for one holder/trader or onchain analytics source before adding live scheduler dependencies | Live provider scheduling and public payload expansion | Replay tests prove fixture-only analytics can be replaced without overclaiming live coverage |
